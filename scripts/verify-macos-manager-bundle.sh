...
test -f "$app_path/Contents/Resources/CodexProSafeManager.icns"
test -f "$pkg_path"
test -f "$checksum_path"
plutil -lint "$app_path/Contents/Info.plist"
test "$(defaults read "$app_path/Contents/Info" CFBundleIdentifier)" = "com.prometheusprophet.codexpro-safe-manager"
test "$(defaults read "$app_path/Contents/Info" CFBundleIconFile)" = "CodexProSafeManager.icns"
...
grep -Fq 'CodexPro-Safe Manager.app/Contents/Resources/CodexProSafeManager.icns' <<<"$payload_files"
